...
- Validate all four API3 recipe slots across three providers, chain block timing/native-token fee behavior, immutable coordinator/registry/key configuration and application-payment refunds.
