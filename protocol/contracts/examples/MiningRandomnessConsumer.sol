...
import {ArcVRFConsumer} from "../ArcVRFConsumer.sol";
...
abstract contract MiningRandomnessConsumer is ArcVRFConsumer {
    ...
    function candidateSeed(uint256 claimId, uint8 candidate) public view returns (bytes32) {
        ...
        return keccak256(abi.encode(
            keccak256("VRF_ARCDAO_CARD_V1"), block.chainid, address(this),
