...
assert.equal(fixtureProvenance.sourceMode,'live API3');
...
assert.deepEqual(coveredSources,[0,1,2,3], 'Actual live API3 fixture coverage must include all four recipe slots');
assert.equal(registry.deploy.inputs[0].type,'address[4]');
...
console.log('Actual recipe fixture coverage: '+coveredSources.join(', '));
