...
const required = ['AGENTS.md', 'LICENSE', 'README.md', 'BUILD-MANIFEST.json', 'dist/index.js', 'dist/index.d.ts',
  'dist/abi.js', 'dist/abi.d.ts', 'abi/ArcVRFCoordinator.json', 'examples/DiceConsumer.sol', 'notices/CHAINLINK-LICENSE'];
...
writeFileSync(resolve(temp, 'package.json'), JSON.stringify({ name: 'sdk-smoke-consumer', private: true, type: 'module' }));
...
import { builtins, mapRandomness, replayCoordinator, decodeEvidencePacket, type MappingSpec } from '@arcdao/vrf-sdk';
